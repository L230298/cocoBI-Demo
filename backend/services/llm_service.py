...
def _mock_intent(input_data: dict) -> dict:
    ...
    if any(k in text for k in ["为什么", "原因", "怎么掉", "怎么涨", "归因", "因素", "分析", "占比", "贡献", "异常", "怎么变", "哪个减少", "为什么下降", "突然", "下降", "在哪些", "哪些城下降", "哪些减少", "哪些掉了", "哪些涨了", "异常下降", "异常减少", "占比是", "贡献率", "对比", "A和B", "A 比 B", "A 跟 B", "对比分析", "对比看"]):
        intent = "AttributeAnalysis"
        confidence = 0.92
    if any(k in text for k in ["按", "组", "维度", "top", "TOP", "排名", "前几", "前10", "最", "环比", "同比", "卖得", "畅销", "热卖", "最好", "前3", "前5", "前2", "前1", "各品类", "各种", "分门", "分组看", "类别分析", "品类分析", "看出", "来看", "拆", "拆解", "哪个城", "哪个产", "每个", "各类各", "按城市", "按渠道", "按地区", "按时间", "按品", "按金额", "排名是", "前几的", "top10", "top 10"]):
    ...
    elif any(k in text for k in ["预警", "阈值", "超过", "低于", "不足", "异常低", "异常高"]):
        intent = "ThresholdAlert"
        confidence = 0.85
    elif any(k in text for k in ["解读", "解释", "说明", "怎么样", "分析一下", "不同", "有什么区别", "消费行为", "行为", "解读一下", "帮我看", "看一下", "前后", "看看", "看一下"]):
