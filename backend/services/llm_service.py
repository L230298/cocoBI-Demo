...
def _mock_intent(input_data: dict) -> dict:
    ...
    if any(k in text for k in ["为什么", "原因", "怎么掉", "怎么涨", "归因", "因素", "分析", "占比", "贡献", "异常", "怎么变", "哪个减少", "为什么下降", "突然", "下降", "在哪些", "哪些城下降", "哪些减少", "哪些掉了", "哪些涨了", "异常下降", "异常减少", "占比是", "贡献率"]):
        ...
        confidence = 0.92
    if any(k in text for k in ["按", "组", "维度", "top", "TOP", "排名", "前几", "前10", "最", "对比", "环比", "同比", "卖得", "畅销", "热卖", "最好", "前3", "前5", "前2", "前1", "各品类", "各种", "分门", "分组看", "类别分析", "品类分析", "看出", "来看", "拆", "拆解", "哪个城", "哪个产", "每个", "各类各", "按城市", "按渠道", "按地区", "按时间", "按品", "按金额", "排名是", "前几的", "top10", "top 10"]):
